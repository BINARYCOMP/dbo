...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2018 at 11:27 PM
...
INSERT INTO `inventaris` (`INVE_ID`, `INVE_KEADAAN`, `INVE_KETERANGAN`, `INVE_QTY`, `INVE_INPA_ID`, `INVE_INCH_ID`, `INVE_TIME`, `INVE_USER_ID`) VALUES
(1, 'Baik', '', 10, 22, 57, '2018-06-09 05:13:34', 1),
(2, 'Baik', '', 1, 1, 1, '2018-06-09 03:03:02', 1),
(3, 'Baik', '', 1, 18, 0, '2018-06-09 03:11:45', 1);
...
(3, 'hasil produksi di edit', 0, 900, 1432, '2018-06-23 21:10:18', 1, 1, 1, 1, '2018-06-24');
...
--
ALTER TABLE `inventaris`
  MODIFY `INVE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
