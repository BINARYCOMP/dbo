...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2018 at 07:15 AM
...
INSERT INTO `barang_cimuning_child` (`BACC_ID`, `BACC_NAME`, `BACC_TIMESTAMP`, `BACC_SATU_ID`) VALUES
(2, 'SWC 6-16 Nilon', '2018-05-30 17:21:47', 5);
...
INSERT INTO `gudang_bawang` (`GUBA_ID`, `GUBA_URAIAN`, `GUBA_KELUAR`, `GUBA_MASUK`, `GUBA_SALDO`, `GUBA_TIMESTAMP`, `GUBA_BAPA_ID`, `GUBA_BACH_ID`, `GUBA_KATE_ID`, `GUBA_RUAN_ID`, `GUBA_USER_ID`) VALUES
(1, 'STOK AWAL', 0, 500, 500, '2018-06-09 04:53:24', 1, 1, 1, 1, 1),
(2, 'STOK AWAL', 0, 90, 90, '2018-06-09 04:53:39', 18, 172, 1, 3, 1),
(3, 'Hasil Produksi', 0, 90, 590, '2018-06-09 04:53:42', 1, 1, 0, 1, 1),
(4, 'STOK AWAL', 0, 1000, 1000, '2018-06-09 05:08:04', 1, 2, 1, 6, 1);
...
INSERT INTO `gudang_jadi` (`GUJA_ID`, `GUJA_URAIAN`, `GUJA_KELUAR`, `GUJA_MASUK`, `GUJA_SALDO`, `GUJA_TIMESTAMP`, `GUJA_BACC_ID`, `GUJA_KATE_ID`, `GUJA_RUAN_ID`, `GUJA_USER_ID`) VALUES
(1, 'STOK AWAL', 0, 500, 500, '2018-05-30 17:22:14', 2, 0, 1, 0),
(2, 'stok awal', 0, 50, 50, '2018-06-08 12:44:25', 2, 1, 1, 1);
...
INSERT INTO `gudang_tak_jadi` (`GUTA_ID`, `GUTA_URAIAN`, `GUTA_KELUAR`, `GUTA_MASUK`, `GUTA_SALDO`, `GUTA_TIMESTAMP`, `GUTA_BACC_ID`, `GUTA_KATE_ID`, `GUTA_RUAN_ID`, `GUTA_USER_ID`) VALUES
(1, 'HASIL PRODUKSI', 0, 90, 90, '2018-06-09 04:57:34', 2, 0, 3, 1);
...
INSERT INTO `material_bawang` (`MABA_ID`, `MABA_URAIAN`, `MABA_KELUAR`, `MABA_MASUK`, `MABA_SALDO`, `MABA_TIMESTAMP`, `MABA_MPBA_ID`, `MABA_MCBA_ID`, `MABA_RUAN_ID`, `MABA_USER_ID`) VALUES
(1, 'STOK AWAL', 0, 505, 505, '2018-06-09 05:08:27', 2, 13, 1, 1);
...
(13, 'Insert 25-35', 505, '2018-05-30 17:39:22', 2, 2),
...
(1, 'NYLON', 509, '2018-05-30 18:00:49', 8, 1);
...
INSERT INTO `material_cimuning` (`MACI_ID`, `MACI_URAIAN`, `MACI_KELUAR`, `MACI_MASUK`, `MACI_SALDO`, `MACI_TIMESTAMP`, `MACI_MPCI_ID`, `MACI_MCCI_ID`, `MACI_RUAN_ID`, `MACI_USER_ID`) VALUES
(1, 'STOK AWAL', 0, 509, 509, '2018-06-09 05:08:30', 1, 1, 1, 1);
...
--
ALTER TABLE `barang_cimuning_child`
  MODIFY `BACC_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `gudang_bawang`
  MODIFY `GUBA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `gudang_jadi`
--
ALTER TABLE `gudang_jadi`
  MODIFY `GUJA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `gudang_tak_jadi`
--
ALTER TABLE `gudang_tak_jadi`
  MODIFY `GUTA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `material_bawang`
  MODIFY `MABA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `material_cimuning`
  MODIFY `MACI_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
