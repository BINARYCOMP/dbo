...
--
-- Struktur dari tabel `material_bawang`
--
...
--
-- Struktur dari tabel `material_child_bawang`
--
...
--
-- Struktur dari tabel `material_child_cimuning`
--
...
--
-- Struktur dari tabel `material_cimuning`
--
...
--
-- Struktur dari tabel `material_parent_bawang`
--
...
--
-- Struktur dari tabel `material_parent_cimuning`
--
...
--
-- AUTO_INCREMENT untuk tabel `material_bawang`
--
ALTER TABLE `material_bawang`
  MODIFY `MABA_ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `material_child_bawang`
--
ALTER TABLE `material_child_bawang`
  MODIFY `MCBA_ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `material_child_cimuning`
--
ALTER TABLE `material_child_cimuning`
  MODIFY `MCCI_ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `material_cimuning`
--
ALTER TABLE `material_cimuning`
  MODIFY `MACI_ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `material_parent_bawang`
--
ALTER TABLE `material_parent_bawang`
  MODIFY `MPBA_ID` int(11) NOT NULL AUTO_INCREMENT;
