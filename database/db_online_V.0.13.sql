...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Apr 2018 pada 19.31
...
--
-- Struktur dari tabel `cimuning_material`
--

CREATE TABLE `cimuning_material` (
  `CIMA_ID` int(11) NOT NULL,
  `CIMA_URAIAN` text NOT NULL,
  `CIMA_KELUAR` int(11) NOT NULL,
  `CIMA_MASUK` int(11) NOT NULL,
  `CIMA_SALDO` int(11) NOT NULL,
  `CIMA_TIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CIMA_MAPA_ID` int(11) NOT NULL,
  `CIMA_MACH_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `material_child` (
  ...
  `MACH_CIMA_TOTAL` int(11) NOT NULL,
...
--
-- Indeks untuk tabel `cimuning_material`
--
ALTER TABLE `cimuning_material`
  ADD PRIMARY KEY (`CIMA_ID`);
...
--
-- AUTO_INCREMENT untuk tabel `cimuning_material`
--
ALTER TABLE `cimuning_material`
  MODIFY `CIMA_ID` int(11) NOT NULL AUTO_INCREMENT;
