...
--
-- Host: 127.0.0.1
-- Generation Time: 17 Apr 2018 pada 12.16
...
--
-- Dumping data untuk tabel `gudang_jadi`
--

INSERT INTO `gudang_jadi` (`GUJA_ID`, `GUJA_KELUAR`, `GUJA_MASUK`, `GUJA_TIMESTAMP`, `GUJA_BAPA_ID`, `GUJA_BACH_ID`) VALUES
(1, 0, 0, '2018-04-16 02:00:53', 1, 1);
...
--
ALTER TABLE `gudang_jadi`
  MODIFY `GUJA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
