...
<section class="content">
  <div class="row">
                      ...
                      <div class="col-md-12 ">
                        <div class="form-group">
                          ...
                          <div class="input-group autocomplete">
                            <!-- /btn-group -->
                            <input id="myInput" class="form-control" value="<?=$guta[0]['BACC_NAME']?>" type="text" onchange="showChild(this.value)" name="cmbParentMuncul"  placeholder="== Pilih Induk Barang ==">
                            <input class="form-control" value="<?=$guta[0]['BACC_ID']?>" id="cmbParent" type="hidden" name="cmbParent">
                            ...
                            <select name="cmbKategori" onchange="showStok();" onmousemove="showStok();" id="cmbKategori" class="form-control">
                              ...
                              <?php  
                                foreach ($namaKategori as $row){
                                  if ($row['KATE_ID'] == $guta[0]['GUTA_KATE_ID']) {
                            ...
                            <select required name="cmbRuangan" id="cmbRuangan" onchange="showStok()" class="form-control">
                              ...
                              <?php  
                                foreach ($dataRuangan as $row){
                                  if ($row['RUAN_ID'] == $guta[0]['GUTA_RUAN_ID']) {
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="txtUraian" class="form-control" id="keterangan" rows="3" placeholder="Keterangan barang.."><?=$guta[0]['GUTA_URAIAN']?></textarea>
                        </div>

                        <div class="form-group">
                            <label class=" control-label">Masuk</label>
                            <div>
                              <input type="number" name="txtMasuk" id="brgMasuk" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control" value="<?=$guta[0]['GUTA_MASUK']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                              <input type="number" name="txtKeluar" id="brgKeluar" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control" value="<?=$guta[0]['GUTA_KELUAR']?>">
                            </div>
                        </div>
      ...
      ?>
      <div class="col-md-12">
        <?php $this->load->view('table/table_gudang_cimuning_setengah_jadi') ?>
      </div>
  </div>
  <!-- /.box -->
...
<script>
  function modalKonfirmasiJadi() {
    ...
    xhttp.open("GET", "<?php echo base_url()?>c_gudangTakJadi/modalKonfirmasiEdit/<?=$guta[0]['GUTA_ID']?>/?parent="+parent+"&kategori="+kategori+"&keterangan="+keterangan+"&masuk="+masuk+"&keluar="+keluar+"&ruangan="+ruangan+"&tanggal="+tanggal, true);
    xhttp.send();   
  }
