  ...
  <div class="row">
      <div class="col-md-12">
        <div class="box box-success collapsed-box">
          <div class="box-header with-border">
            <h3 class="box-title">Tabel Gudang Cimuning Jadi</h3>
      ...
      <div class="col-md-12">
        <div class="box collapsed-box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Tabel Gudang Cimuning Setengah Jadi</h3>
        ...
        if ($_SESSION['level'] != 'MANAGERIAL' ) {
          ...
          <div class="col-md-12">
            <div class="box collapsed-box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">Tabel Gudang Bawang </h3>
              ...
              <div class="box-body" style="display: none">
                <div class="row">
                  <div class="col-md-12 ">
                    <table class="table table-bordered table-hover table-striped" id="guba">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Induk Barang</th>
