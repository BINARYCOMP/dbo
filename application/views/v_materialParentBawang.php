...
<div class="content">
	<div class="row">
	  <div class="col-md-6">
	    <div class="box box-info">
	      <div class="box-header with-border">
	        <h3 class="box-title">Input Material Parent Bawang</h3>
	      ...
	      <div class="box-body">
	        <div class="row">
	          <div class="col-md-12 ">
	            <form action="<?php echo base_url(). 'c_materialParentBawang/form'; ?>" method="POST">
	              <div class="form-group">
	                  <label class=" control-label">Input Material Parent Bawang</label>
	                  <div>
	                    <span id="qty">
	  ...
	  <div class="col-md-6">
	    <div class="box box-info">
	      <div class="box-header with-border">
	        <h3 class="box-title">Data Material Parent Bawang</h3>
