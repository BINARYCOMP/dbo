                      ...
                      <div class="col-md-12 ">
                        <div class="form-group">
                          ...
                          <div class="input-group autocomplete">
                            <!-- /btn-group -->
                            <input id="myInput" class="form-control" type="text" onchange="showChild(this.value)" name="cmbParentMuncul" value="<?=$guja[0]['BACC_NAME']?>"  placeholder="== Pilih Induk Barang ==">
                            <input class="form-control" id="cmbParent" value="<?=$guja[0]['BACC_ID']?>" type="hidden" name="cmbParent">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="txtUraian" class="form-control" id="keterangan" rows="3" placeholder="Keterangan barang.."><?=$guja[0]['GUJA_URAIAN']?></textarea>
                        </div>

                        <div class="form-group">
                            <label class=" control-label">Masuk</label>
                            <div>
                              <input type="number" name="txtMasuk" value="<?=$guja[0]['GUJA_MASUK']?>" id="brgMasuk" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                              <input type="number" name="txtKeluar" value="<?=$guja[0]['GUJA_KELUAR']?>" id="brgKeluar" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control">
                            </div>
                        </div>
...
<script>
  function modalKonfirmasiJadi() {
    ...
    xhttp.open("GET", "<?php echo base_url()?>c_gudangJadi/modalKonfirmasiEdit/<?=$guja[0]['GUJA_ID']?>/?parent="+parent+"&kategori="+kategori+"&keterangan="+keterangan+"&masuk="+masuk+"&keluar="+keluar+"&ruangan="+ruangan+"&tanggal="+tanggal, true);
    xhttp.send();   
  }
