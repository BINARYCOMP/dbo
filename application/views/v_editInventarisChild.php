			          ...
			          <div class="col-md-12 ">
			            <form action="<?php echo base_url(). 'c_barangChild/form'; ?>" method="POST">
			              <div class="form-group">
			                  ...
			                  <div>
			                    <span >
			                      <input class="form-control" type="text"  name="txtguja" required="true" value="<?php echo($barangChild[0]['BACH_GUJA_TOTAL'])?>">  
			                    </span>
			                  </div>
			                  <label class=" control-label">Gudang Tak Jadi</label>
			                  <div>
			                    <span >
			                      <input class="form-control" type="text"  name="txtguta" required="true" value="<?php echo($barangChild[0]['BACH_GUTA_TOTAL'])?>"	>  
			                    </span>
			                  </div>
			                  <label class=" control-label">Barang Parent</label>
			                  <div>
			                    <span >
			                      <input class="form-control" type="text"  name="txtbapa" required="true" value="<?php echo($barangChild[0]['BACH_BAPA_ID'])?>" >  
			                    </span>
			                  </div>
			                  <label class=" control-label">Satuan Barang</label>
			                  <div>
			                    <span >
			                      <input class="form-control" type="text"  name="txtsatuan" required="true" value="<?php echo($barangChild[0]['BACH_SATU_ID'])?>">  
			                    </span>
			                  </div>
