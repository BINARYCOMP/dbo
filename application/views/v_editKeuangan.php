			            ...
			            <form action="<?php echo base_url(). 'c_keuangan/update/' .$keuangan[0]['KEUA_ID']; ?>" method="POST">
			              ...
			              <div class="form-group">
			                <div class="row">
			                  ...
			                  <div class="col-md-2">
			                    <button type="submit"  name="btnSubmit" value="Simpan" class="btn btn-info pull-right" data-toggle="modal" data-target="#modal-success2" onclick="modalKonfirmasiTakJadi()" >Input Data</button>
			                  </div>
			                </div>
			              </div>
			            </form>
