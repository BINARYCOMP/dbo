	  ...
	  <div class="col-md-6">
	    <div class="box box-info">
	      ...
	      <div class="box-body">
	        <div class="row">
	          <div class="col-md-12 ">
	            <form action="<?php echo base_url(). 'c_barangParentCimuning/UpdateData/' .$barangParentCimuning[0]["BACP_ID"]; ?>" method="POST">
	              <div class="form-group">
	                  <label class=" control-label">Nama Barang Parent</label>
	                  <div>
	                    <span >
	                      <input class="form-control" type="text"  name="txtnama" required="true" value="<?php echo($barangParentCimuning[0]['BACP_NAME'])?>">  
	                    </span>
	                  </div>
	              </div>
	              <div class="form-group">
