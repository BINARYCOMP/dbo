...
<div class="content">
	<div class="row">
	  <div class="col-md-6">
	    <div class="box box-warning">
	      <div class="box-header with-border">
	        <h3 class="box-title">Input Material Child Bawang</h3>
	      ...
	      <div class="box-body">
	        <div class="row">
	          <div class="col-md-12 ">
	            <form action="<?php echo base_url(). 'c_materialBawangChild/form'; ?>" method="POST">
	  ...
	  <div class="col-md-6">
	    <div class="box box-warning">
	      <div class="box-header with-border">
	        <h3 class="box-title">Data Material Child Bawang </h3>
				...
				<tbody>
					...
					$no = 1;
		 				foreach ($bawang_child as $row) {
		 					...
		 					echo "<td><a href='".base_url()."c_materialBawangChild/FormUpdate/".$row['MCBA_ID']."'>Edit</a> | <a href='".base_url()."c_materialBawangChild/delete/".$row['MCBA_ID']."' onclick= 'return confirm(\"Are you sure?\")'>Delete</a></td>";
		 					echo "</tr>";
		 					$no++;
		 				}
		 			 ?>
