...
<section class="content">
  <div class="row">
                    ...
                    <div class="col-md-12 ">
                      <div class="form-group">
                        ...
                        <div class="input-group autocomplete">
                          <!-- /btn-group -->
                          <input id="myInput" class="form-control" type="text" value="<?=$guba[0]['BAPA_NAME']?>" name="cmbParentMuncul"  placeholder="== Pilih Induk Barang ==">
                          <input class="form-control" value="<?=$guba[0]['BAPA_ID']?>" id="cmbParent" type="hidden" onchange="showChild(this.value)" name="cmbParent">
                          ...
                          <select name="cmbKategori"  id="cmbKategori" class="form-control" onchange="showStok();" onmousemove="showStok();">
                            ...
                            <?php  
                              foreach ($namaKategori as $row){
                                if ($row['KATE_ID'] == $guba[0]['GUBA_KATE_ID']) {
                                  echo "<option value='".$row['KATE_ID']."' selected>";
                                  echo $row ['KATE_NAME'];
                                  echo "</option>";
                                }else{
                          ...
                          <select name="cmbRuangan"  onchange="showStok();" onmousemove="showStok()" id="cmbRuangan" class="form-control">
                            ...
                            <?php  
                              foreach ($dataRuangan as $row){
                                if ($row['RUAN_ID'] == $guba[0]['GUBA_RUAN_ID']) {
                      ...
                      <div class="form-group">
                          ...
                          <div>
                            <input type="number" name="txtMasuk" id="brgMasuk" value="<?=$guba[0]['GUBA_MASUK']?>" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="">
                            <input type="number" name="txtKeluar" id="brgKeluar" value="<?=$guba[0]['GUBA_KELUAR']?>" onkeyup="showSaldo()" onclick="showSaldo()" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <button class="btn btn-info pull-right" type="button"  onclick="modalKonfirmasiJadi()" >Input Data</button>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <?php } ?>
    <div class="col-md-12">
      <?php $this->load->view('table/table_gudang_bawang')?>
    </div>
  </div>
  <!-- /.box -->
</section>
...
<div class="modal fade" id="modal-success">
  <div class="modal-dialog modal-lg modal-success" id="modalKonfirmasiJadi">
...
function showChild(str) {
  ...
  xhttp.open("GET", "<?php echo base_url()?>c_gudangBawang/searchChild?q="+str+"&edit=<?=$guba[0]['BACH_ID']?>", true);
  xhttp.send();   
}
</script>
...
<script>
  function modalKonfirmasiJadi() {
    ...
    xhttp.open("GET", "<?php echo base_url()?>c_gudangBawang/modalKonfirmasiEdit/<?=$guba[0]['GUBA_ID']?>/?parent="+parent+"&child="+child+"&kategori="+kategori+"&keterangan="+keterangan+"&masuk="+masuk+"&keluar="+keluar+"&ruangan="+ruangan+"&tanggal="+tanggal, true);
    xhttp.send();   
  }
