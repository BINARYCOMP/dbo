<?php
  ...
  class M_materialCimuning extends CI_Model
  {
    ...
    public function getFirstStock($mcci_id,$mpci_id,$ruan_id)
    {
      $sql="SELECT * from material_cimuning, material_parent_cimuning, material_child_cimuning, ruangan where maci_mcci_id = mcci_id and maci_mpci_id = mpci_id and maci_ruan_id = ruan_id and maci_ruan_id = ".$ruan_id." and maci_mcci_id = ".$mcci_id." and maci_mpci_id = ".$mpci_id." group by maci_id desc limit 1";
    ...
    public function getRuangan()
    {
     ...
     public function getFirstStockWithoutRuangan($mcci_id,$mpci_id)
    {
      $sql="SELECT * from material_cimuning, material_parent_cimuning, material_child_cimuning where maci_mcci_id = mcci_id and maci_mpci_id = mpci_id and maci_mcci_id = ".$mcci_id." and maci_mpci_id = ".$mpci_id." group by mpci_id desc limit 1";
      $query=$this->db->query($sql);
      $return = $query->result_array();
      return $return;
    }
